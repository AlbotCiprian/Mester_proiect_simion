...
/**
 * Romanian copy for the fifteen topic pages, keyed by slug.
 *
 * Extracted verbatim from the inline version in lib/landing.ts when the file
 * was split per locale — the words are unchanged, so nothing that was reviewed
 * and shipped needs re-reviewing.
 *
 * The rules from lib/landing.ts apply here and are enforced by
 * tests/landing.test.ts: no price, no warranty period, no response time, no
 * unconfirmed locality, no review.
 */
export const landingTextRo: Record<string, LandingText> = {
  "montaj-gresie-faianta": {
    h1: "Montaj gresie și faianță în Chișinău",
    metaTitle: "Montaj gresie și faianță în Chișinău",
    metaDescription: "Montaj de gresie și faianță executat cu suport pregătit, nivel laser și rosturi calibrate. Vezi etapele, greșelile care se plătesc mai târziu și fotografii din lucrări reale.",
  ...
  "renovare-baie-la-cheie": {
    ...
    metaDescription: "Renovare completă de baie: demolare, instalații, hidroizolație, placare și montaj sanitar, coordonate de o singură echipă. Etape, decizii și fotografii din lucrări reale.",
  ...
  "reparatie-baie": {
    ...
    metaDescription: "Reparație de baie în apartamente de bloc: ce se poate repara punctual, ce merită refăcut complet și cum se decide între cele două. Exemple din lucrări executate.",
  ...
  "hidroizolatie-baie": {
    ...
    metaDescription: "Hidroizolația din baie se face sub placare, nu la finisaj: unde se aplică, cum se tratează colțurile și trecerile de țevi, și de ce plăcile singure nu sunt o barieră de apă.",
  ...
  "dus-fara-prag-cuva-zidita": {
    ...
    metaDescription: "Duș la nivelul pardoselii, cu cuvă zidită și rigolă liniară: cum se stabilesc pantele, unde se pune hidroizolația și ce decizii trebuie luate înainte de șapă.",
    kicker: "Zona umedă",
    intro: [
  ...
  "placare-cada-baie": {
    ...
    metaDescription: "Cadă îmbrăcată complet în plăci, cu muchii tăiate la 45° și tipar continuat de pe perete. Cum se construiește, unde se lasă vizitarea și ce se etanșează cu silicon.",
  ...
  "montaj-wc-suspendat": {
    ...
    metaDescription: "WC suspendat cu rezervor încastrat: cum se dimensionează coloana, unde cad rosturile pe peretele placat și de ce cadrul se cumpără înainte de a construi ceva.",
  ...
  "teracota": {
    ...
    metaDescription: "Lucrări de teracotă și placări ceramice decorative: selecția tiparului, alinierea pe module și racordurile curate. Ce cerem înainte de a începe și cum se execută.",
  ...
  "placare-terasa": {
    ...
    metaDescription: "Placare de terasă rezistentă la îngheț: pante, rosturi de dilatare, adezivi și chituri pentru exterior. De ce o placare de interior mutată afară crapă în prima iarnă.",
    kicker: "Exterior",
    intro: [
  ...
  "placare-scari-trepte": {
    ...
    metaDescription: "Placarea treptelor: cum se calculează înălțimea egală, ce muchie se alege, ce clasă antiderapantă are sens afară și cum se evacuează apa de pe fiecare treaptă.",
    kicker: "Exterior",
    intro: [
  ...
  "placare-fatada": {
    ...
    metaDescription: "Placarea fațadei cu porțelan de format mare: cerințele de suport, adezivul, rosturile de dilatare și de ce greutatea plăcii schimbă complet sistemul de montaj.",
    kicker: "Exterior",
    intro: [
  ...
  "incalzire-in-pardoseala": {
    ...
    metaDescription: "Cablu de încălzire sub gresie: ordinea corectă a straturilor, poziția senzorului, de ce nu se pornește imediat și ce nu trebuie acoperit niciodată cu mobilier fix.",
    kicker: "Confort",
    intro: [
  ...
  "placi-format-mare": {
    ...
    metaDescription: "Plăci de format mare: de ce cer suport mult mai plan, ce înseamnă decalajul corect între rânduri, cum se evită denivelările și când formatul mare nu este alegerea potrivită.",
    kicker: "Formate mari",
    intro: [
  ...
  "mester-gresie-faianta-chisinau": {
    ...
    metaDescription: "Cum alegi un meșter de gresie și faianță: ce fotografii să ceri, ce întrebări separă un profesionist de restul și cum lucrăm noi. Fotografii din lucrări reale.",
    kicker: "Cum lucrăm",
    intro: [
  ...
  "cat-costa-montajul-gresie-faianta": {
    ...
    metaDescription: "De ce prețul pe metru pătrat nu spune nimic singur, ce factori schimbă costul unei placări și ce informații trebuie să dai ca să primești o ofertă care nu se schimbă pe parcurs.",
